    ...
    do 
        ...
        do
            python $BASE/main.py \
                ...
                --num_clients 1 --clients_path $BASE/client_centr \
                --fed_test_options centralized \
                --batch_size 1 --lr $lr --opt radam --reg $decay --max_rounds 300 --patience 25 --test_dir $BASE/client_centr/test_set --val_dir train-val_split.csv \
