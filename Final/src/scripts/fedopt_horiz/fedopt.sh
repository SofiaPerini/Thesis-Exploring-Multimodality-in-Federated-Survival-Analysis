        ...
        do
            ...
            do
                python $BASE/main.py \
                    ...
                    --fed_test_options federated --fed_method fedopt \
                    --batch_size 1  --lr_client $lr --lr_server $lr_s --opt radam --reg $decay --max_rounds 300 --patience 32 --lr_pat 20 --test_dir test.csv --val_dir val.csv --train_dir train.csv \
